...
# SCP Applet errors #
ERROR_MSG[K_MODULE_PM][28] = "ERR_SCP_APLT_NO_SYNC : Synchronization pattern is not present in header"
ERROR_MSG[K_MODULE_PM][29] = "ERR_SCP_APLT_VERSION_MISMATCH : Applet target version does not match ROM code's one"
ERROR_MSG[K_MODULE_PM][30] = "ERR_SCP_APLT_WD_ERROR : an error occurs with WRITE_DATA primitive treatment"
ERROR_MSG[K_MODULE_PM][31] = "ERR_SCP_APLT_CD_ERROR : an error occurs with COMPARE_DATA primitive treatment"
ERROR_MSG[K_MODULE_PM][32] = "ERR_SCP_APLT_ED_ERROR : an error occurs with ERASE_DATA primitive treatment"
ERROR_MSG[K_MODULE_PM][33] = "ERR_SCP_APLT_NO_REGISTERED : No applet registered"
ERROR_MSG[K_MODULE_PM][34] = "ERR_SCP_APLT_NOT_HANDLED : Not handled by applet"

# SCP application command errors #
ERROR_MSG[K_MODULE_PM][35] = "ERR_SCP_APPLI_COMPARE_FAILURE : Compare failed"

# SCP command specific errors #
ERROR_MSG[K_MODULE_PM][36] = "ERR_SCP_OLD_CRK_NO_MATCH : Old CRK does not match"
ERROR_MSG[K_MODULE_PM][37] = "ERR_UNKNOWN : Generic error for unknown behavior"
