...
ERROR_MSG = x = [['                                                                        ' for i in range(39)] for j in range(14)]
...
# OTP part #
ERROR_MSG[K_MODULE_MM][7] = "ERR_OTP_PGM_FAILED: OTP programmation failed"
ERROR_MSG[K_MODULE_MM][8] = "ERR_OTP_FAILURE: OTP internal failure"
# Secure NVSRAM part #
ERROR_MSG[K_MODULE_MM][9] = "ERR_AES_GENERATION_FAILED: AES key generation failed"
ERROR_MSG[K_MODULE_MM][10] = "ERR_UNKNOWN : Generic error for unknown behavior"
...
ERROR_MSG[K_MODULE_PM][26] = "ERR_SCP_NO_SESSION_ALLOWED : SCP window(s) should not be opened"
ERROR_MSG[K_MODULE_PM][27] = "ERR_SCP_CANT_PROCEEED : Command can not be proceeded"
ERROR_MSG[K_MODULE_PM][28] = "ERR_SCP_RESET_ASKED : Platform reset asked"
# SCP Applet errors #
ERROR_MSG[K_MODULE_PM][29] = "ERR_SCP_APLT_NO_SYNC : Synchronization pattern is not present in header"
ERROR_MSG[K_MODULE_PM][30] = "ERR_SCP_APLT_VERSION_MISMATCH : Applet target version does not match ROM code's one"
ERROR_MSG[K_MODULE_PM][31] = "ERR_SCP_APLT_WD_ERROR : an error occurs with WRITE_DATA primitive treatment"
ERROR_MSG[K_MODULE_PM][32] = "ERR_SCP_APLT_CD_ERROR : an error occurs with COMPARE_DATA primitive treatment"
ERROR_MSG[K_MODULE_PM][33] = "ERR_SCP_APLT_ED_ERROR : an error occurs with ERASE_DATA primitive treatment"
ERROR_MSG[K_MODULE_PM][34] = "ERR_SCP_APLT_NO_REGISTERED : No applet registered"
ERROR_MSG[K_MODULE_PM][35] = "ERR_SCP_APLT_NOT_HANDLED : Not handled by applet"

# SCP application command errors #
ERROR_MSG[K_MODULE_PM][36] = "ERR_SCP_APPLI_COMPARE_FAILURE : Compare failed"

# SCP command specific errors #
ERROR_MSG[K_MODULE_PM][37] = "ERR_SCP_OLD_CRK_NO_MATCH : Old CRK does not match"
ERROR_MSG[K_MODULE_PM][38] = "ERR_UNKNOWN : Generic error for unknown behavior"
...
ERROR_MSG[K_MODULE_RCE][10] = "ERR_BANK_OUT_OF_RANGE :  Internal flash bank number does not exist"
ERROR_MSG[K_MODULE_RCE][11] = "ERR_NO_BIN_LOC : No binary location"
ERROR_MSG[K_MODULE_RCE][12] = "ERR_UNKNOWN : Generic error for unknown behavior"
